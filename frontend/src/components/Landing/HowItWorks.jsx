...
const steps = [
  ...
  {
    icon: <Sparkles className="w-10 h-10 text-brand-orange" />,
    title: "Analyze (自動彙整)",
    ...
    <section id="how-it-works" className="py-24 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-5xl font-sans font-bold mb-4 text-white">簡單三步上手</h2>
          <p className="text-slate-400 max-w-xl mx-auto">從混亂到清晰，只需幾分鐘。</p>
        </div>

        <div className="relative">
          {/* Connector Line */}
          <div className="hidden md:block absolute top-1/2 left-20 right-20 h-0.5 bg-gradient-to-r from-brand-blue via-brand-orange to-brand-blue opacity-20 -translate-y-1/2 -z-10" />
            ...
            {steps.map((item, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full glass border-white/20 flex items-center justify-center mb-8 relative bg-slate-900 group shadow-xl">
                  <div className="absolute -inset-2 bg-gradient-to-tr from-brand-blue to-brand-orange rounded-full opacity-0 group-hover:opacity-20 transition-opacity blur-md" />
