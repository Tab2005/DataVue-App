...
const targets = [
  ...
  {
    icon: <Rocket className="w-10 h-10 text-brand-blue" />,
    title: "初創團隊",
    ...
    <section id="target" className="py-24 px-6 bg-slate-900/10">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-sans font-bold mb-4 text-white">適用對象</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {targets.map((item, index) => (
            <motion.div 
              ...
              className="glass p-8 rounded-3xl border-white/5 text-center group hover:bg-white/[0.05] transition-all bg-slate-900/20"
            >
