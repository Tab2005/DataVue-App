...
const features = [
  ...
  {
    icon: <FaFacebook className="w-8 h-8 text-blue-300" />,
  ...
  {
    icon: <Bot className="w-8 h-8 text-orange-300" />,
    title: "DataVue AI Hub",
...
export default function Features() {
  return (
    <section id="features" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-brand-orange/5 rounded-full blur-[100px]" />

      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-sans font-bold mb-4 text-white">核心功能</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className={`glass rounded-3xl p-8 border-white/5 relative overflow-hidden group bg-gradient-to-br ${feature.color} bg-slate-900/20`}
            >
