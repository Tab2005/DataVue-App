    ...
    <footer className="py-20 px-6 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">è®“æ?ä¸€?†é?ç®—ï?<br className="sm:hidden" />?½æ??ºå¥ª?–å??´ç??°ç•¥?©è???/h2>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center gap-10 pt-10 border-t border-white/5">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm text-slate-500">
            <a href="#" className="hover:text-white transition-colors">?‡ä»¶ä¸­å?</a>
            <a href="#" className="hover:text-white transition-colors">API ?ƒè€ƒæ???/a>
            <a href="#" className="hover:text-white transition-colors">?±ç?æ¬Šæ”¿ç­?/a>
            <a href="#" className="hover:text-white transition-colors">?å?æ¢æ¬¾</a>
          </div>

          <div className="text-sm text-slate-600 font-mono">
            Â© 2026 DATAVUE INC. SITE-TEGY READY.
          </div>
        </div>
      </div>
    </footer>
