...
import {
    ...
    gateRowStyle,
    getBacktestVerdict,
    getCandidateReleaseGate,
    metricGridStyle,
    pairTableCellStyle,
    pairTableHeaderStyle,
    panelStyle,
    resolvePairPreviewUrl,
    sectionTitleStyle,
    successPanelStyle,
    warningPanelStyle,
} from './releaseShared';
import { Metric, ReleaseRecordCard } from './releaseComponents';

const ReleaseOverviewContent = ({
    actionMessage,
    backtestError,
    backtestForm,
    backtestLoading,
                                        ...
                                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.82rem', minWidth: '820px' }}>
                                            ...
                                            <tbody>
                                                {backtestRuns.map((run) => {
                                                    const verdict = getBacktestVerdict(run, overview, t);
                            ...
                            <section style={panelStyle}>
                                ...
                                <div style={{
                                    ...
                                    {(overview?.candidates || []).map((candidate) => {
                                        ...
                                        const releaseGate = getCandidateReleaseGate(candidate, t);
...
export default ReleaseOverviewContent;
