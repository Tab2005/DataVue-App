...
_ORIGINAL_TEST_ORDER = {
    ...
    'test_meta_andromeda_review_queue_prefers_stored_asset_uri_over_observed_media_url': 37,
    'test_meta_andromeda_review_queue_falls_back_to_observed_media_url_when_asset_missing': 37,
