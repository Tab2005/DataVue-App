...
class MetaAndromedaLabelPolicy(Base):
    ...
    cpm_low = Column(Float, nullable=True)
    cpm_high = Column(Float, nullable=True)
    cpm_method = Column(String(30), nullable=True)
    cpm_sample_count = Column(Integer, nullable=False, default=0)
