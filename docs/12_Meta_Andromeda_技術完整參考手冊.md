...
| `awareness` | `brand_awareness`、`OUTCOME_AWARENESS`、`reach` | 觸及 / 曝光 | ✗ |
| `video` | `video_views`、`OUTCOME_VIDEO_VIEWS` | VTR / Hook 率 | ✗ |
| `engagement` | `post_engagement`、`OUTCOME_ENGAGEMENT` | 互動率 | ✗ |
