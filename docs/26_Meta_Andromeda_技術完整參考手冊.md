...
- 透過 `OpenRouterClient` 呼叫 OpenAI-compatible API（當前模型：`openai/gpt-4o-mini`）
...
| 版本 ID | 提供者 | 模型 | 發佈頻道 |
|---|---|---|---|
| `prod_v2026_05_28` | openrouter | `openai/gpt-4o-mini` | production |
| `prod_v2026_05_12` | heuristic | `heuristic://creative_scoring_v0` | superseded |
| `cand_v2026_06_05_a` | openrouter | `openai/gpt-4o-mini` | candidate |
| `cand_v2026_06_04_b` | openrouter | `openai/gpt-4o-mini` | candidate |
