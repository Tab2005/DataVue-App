...
以下說明各標籤的實際意涵與對應的廣告操作建議，適用於監控工作台「投放趨勢」及「各期報告明細」的標籤解讀。

---

#### 雙重有利（dual_advantage）
**判定條件：ρ ≥ 0.30 且 ROAS ≥ P50**

創意品質與市場環境同步有利：高評分素材確實在帶動更高的 ROAS，且整體帳號 ROAS 也高於中位數。這是最理想的投放狀態。

- 創意優化的投資報酬率最高，值得積極投入
- 高分素材可安心擴量，不用擔心邊際效益快速遞減
- 建議維持現有創意供應節奏，同步考慮提升預算規模
...
整體 ROAS 表現不錯，但創意評分與 ROAS 排名的相關性很低（ρ 接近 0）。這代表**成績不是素材好，而是市場環境在撐**：可能是受眾定向精準、競價策略有利、季節需求旺盛，或三者兼具。

常見誤判：把這個時期的亮眼 ROAS 歸功於創意，進而加大創意投資 → 事實上換掉素材 ROAS 不會明顯下滑，因為驅動因子不在創意端。

操作建議：
- **優先鞏固受眾定向與競價策略**，這才是當前績效的根基
- 創意只要達標（不拖累帳號表現）即可，不需要過度優化
- 不要在這個時期做大規模素材汰換測試，訊號容易被市場因素干擾

---

#### 創意突圍（creative_critical）
**判定條件：ρ ≥ 0.30 且 ROAS < P50**

創意評分確實對 ROAS 排名有顯著影響（ρ 高），但整體帳號 ROAS 低於中位數。這代表**市場環境困難，但創意是當前唯一可控的差異因子**：高分素材相對低分素材仍有明顯 ROAS 優勢，只是整體水位偏低。

這是創意優化投資報酬率第二高的狀態（僅次於雙重有利）。

操作建議：
- **積極汰換低分素材**，優先保留高分素材的預算
- 高分素材要主動擴量（即使絕對 ROAS 不高，相對優勢仍存在）
- 評估是否有外部因素壓制整體 ROAS（競爭加劇、季節性需求低谷）
- 市場環境改善後，若創意仍維持高影響力，可望進入「雙重有利」象限
...
創意無效 + 整體績效也差，兩個指標同步失調。這是需要最謹慎應對的狀態，問題可能來自多個層面同時發生。

這個標籤**不代表創意一定有問題**，也可能是定向、出價、產品競爭力、或素材疲乏（同一批素材跑太久）導致。

操作建議：
- 暫緩大規模擴量，避免在問題未釐清前燒更多預算
- 系統性逐項排查：產品競爭力、受眾定向精準度、出價策略、素材新鮮度
- 嘗試引入全新素材測試（舊素材可能已疲乏），觀察新素材能否拉高 ρ
- 若多個連續期間都維持此象限，建議對整體投放策略進行深度覆盤

---

#### 如何使用監控工作台的投放趨勢

「投放趨勢」時間軸顯示帳號在各個 Drift 報告期間的象限演變。觀察重點：

1. **象限是否穩定**：連續多期同一象限代表投放環境結構穩定；頻繁切換代表外部環境變化大
2. **象限切換方向**：「市場護航 → 創意突圍」代表市場優勢消退、創意重要性上升，是優化素材的好時機
3. **ρ² 的長期趨勢**：ρ² 穩定提升代表 Andromeda 評分系統的校準品質正在改善
4. **[自訂]標籤**：表示該期間的觀察窗口為手動指定的自訂時間區間，非系統預設的滾動窗口
