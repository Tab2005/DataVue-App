    ...
    >
      <div className="max-w-7xl mx-auto glass rounded-2xl px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="text-sm font-medium text-white hover:opacity-80 transition-opacity hidden sm:block">登入</button>
          <button className="bg-brand-orange hover:bg-brand-orange-hover text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow-lg shadow-brand-orange/20 hover:scale-105 transition-transform active:scale-95">
            免費體驗
          </button>
        </div>
      </div>
