    ...
    <footer className="py-20 px-6 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-sans font-bold mb-6 text-white leading-tight">讓每一分預算，<br className="sm:hidden" />都成為奪取市場的戰略物資。</h2>
          <button className="bg-brand-orange hover:bg-brand-orange-hover text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-2xl shadow-brand-orange/20 hover:scale-105 transition-transform active:scale-95">
            立即建立您的 DataVue 工作區
          </button>
        </div>
