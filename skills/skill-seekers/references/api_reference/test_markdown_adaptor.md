# API Reference: test_markdown_adaptor.py

**Language**: Python

**Source**: `tests\test_adaptors\test_markdown_adaptor.py`
...
##### test_enhance_returns_false(self)
...
##### test_package_readme_content(self)
...
##### test_package_combined_documentation(self)
...
##### test_upload_not_supported(self)
...
##### test_package_output_filename(self)
